...
Here, spatial audio is integrated into the VR object. This can be verified by the user moving their head in either direction, the audio seems to move in the opposite direction of the head.
